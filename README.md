...
```sh
npm install @exodus/linaria-core @exodus/linaria-react @exodus/linaria-babel @exodus/linaria-shaker
```

or

```sh
yarn add @exodus/linaria-core @exodus/linaria-react @exodus/linaria-babel @exodus/linaria-shaker
```
